...
#docker-compose up ${@:1}
docker-compose -f docker-compose.yml -f minio-docker-compose.yml -f triton-docker-compose.yml down
docker-compose -f docker-compose.yml -f minio-docker-compose.yml -f triton-docker-compose.yml up --build